...
public class Arreglos {
     ...
     * @param el arreglo al que se le sumaran sus elemntos
     * @return suma la suma
     */
    ...
    public static void main(String[] args) {
        pruebasDe2a4();
        // Tus pruebas
	int [] prueba = new int []{1,2,3,4,-5,4,-20,17};
	int resultado = 6;
	suma(prueba);
	if (suma(prueba) == resultado){
	    System.out.println("El inciso 5 esta bien");
		}else{
	    System.out.println("Dió" + suma(prueba) + "y debio regresar" + resultado);
	}
    }
